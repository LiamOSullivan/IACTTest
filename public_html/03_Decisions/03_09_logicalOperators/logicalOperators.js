 ...
 *************************/
function setup() {
    var value1 = true; //declare a variable of type boolean and assign it 'true'
    var value2 = false; //declare a variable of type boolean and assign it 'false'

    println("Value 1 is: " + value1); //print the value of the variable 'value1'

    println("Logical NOT (Inversion) of Value 1 is: " +!value1); //print the inverted (NOT) value of the variable 'value1'
